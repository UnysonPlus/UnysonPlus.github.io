...
| --- | --- | --- | --- | --- | --- | --- |
| [Code Block](./code-block.md) | [`code_block`](/shortcodes/content-elements/code-block) | ✅ 1 | 🟡 0 | ⚠️ 0 | ⚪ 8 | **11%** |
| [Special Heading](./special-heading.md) | [`special_heading`](/shortcodes/content-elements/special-heading) | ✅ 18 | 🟡 0 | ⚠️ 3 | ⚪ 11 | **56%** |
| [Instagram](./instagram.md) | `instagram` | ✅ 3 | 🟡 0 | ⚠️ 0 | ⚪ 6 | **33%** |
| [WooCommerce Products](./wc-products.md) | `wc_products` | ✅ 4 | 🟡 0 | ⚠️ 2 | ⚪ 9 | **27%** |
| [Posts](./posts.md) | [`posts`](/shortcodes/components/posts) | ✅ 7 | 🟡 0 | ⚠️ 2 | ⚪ 47 | **13%** |
| [Avatar](./avatar.md) | [`avatar`](/shortcodes/components/avatar) | ✅ 1 | 🟡 0 | ⚠️ 0 | ⚪ 15 | **6%** |
| [Gallery](./gallery.md) | [`gallery`](/shortcodes/media-elements/gallery) | ✅ 2 | 🟡 0 | ⚠️ 5 | ⚪ 8 | **13%** |
| [Media Video](./media-video.md) | [`media_video`](/shortcodes/media-elements/media-video) | ✅ 1 | 🟡 0 | ⚠️ 1 | ⚪ 4 | **17%** |
| [Media Image](./media-image.md) | [`media_image`](/shortcodes/media-elements/media-image) | ✅ 1 | 🟡 0 | ⚠️ 0 | ⚪ 9 | **10%** |
| [Image Box](./image-box.md) | [`image_box`](/shortcodes/media-elements/image-box) | ✅ 11 | 🟡 0 | ⚠️ 5 | ⚪ 16 | **34%** |
| [Icon Box](./icon-box.md) | [`icon_box`](/shortcodes/components/icon-box) | ✅ 13 | 🟡 0 | ⚠️ 3 | ⚪ 8 | **54%** |
| [Newsletter](./newsletter.md) | [`newsletter`](/shortcodes/interactive-elements/newsletter) | ✅ 8 | 🟡 0 | ⚠️ 2 | ⚪ 10 | **40%** |
| [Text Block](./text-block.md) | [`text_block`](/shortcodes/content-elements/text-block) | ✅ 5 | 🟡 0 | ⚠️ 4 | ⚪ 7 | **31%** |
| [Counter](./counter.md) | [`counter`](/shortcodes/interactive-elements/counter) | ✅ 12 | 🟡 0 | ⚠️ 1 | ⚪ 4 | **71%** |
| [Feature List](./feature-list.md) | [`feature_list`](/shortcodes/components/feature-list) | ✅ 9 | 🟡 0 | ⚠️ 0 | ⚪ 9 | **50%** |
| [Button](./button.md) | [`button`](/shortcodes/components/button) | ✅ 9 | 🟡 0 | ⚠️ 2 | ⚪ 3 | **64%** |
| [Testimonials](./testimonials.md) | [`testimonials`](/shortcodes/components/testimonials) | ✅ 3 | 🟡 0 | ⚠️ 0 | ⚪ 20 | **13%** |
| [Badge](./badge.md) | [`badge`](/shortcodes/content-elements/badge) | ✅ 11 | 🟡 0 | ⚠️ 5 | ⚪ 14 | **37%** |
| [Accordion](./accordion.md) | [`accordion`](/shortcodes/interactive-elements/accordion) | ✅ 17 | 🟡 0 | ⚠️ 1 | ⚪ 10 | **61%** |
| [Table](./table.md) | [`table`](/shortcodes/content-elements/table) | ✅ 3 | 🟡 0 | ⚠️ 5 | ⚪ 13 | **14%** |
...
| --- | --- | --- | --- | --- |
| 99 | `code (universal fallback)` | Anything the converter can’t map to a more specific element — the genuinely bespoke markup. This is the **universal fallback**, so nothing is ever lost. | [Code Block](./code-block.md) → [`code_block`](/shortcodes/content-elements/code-block) | — (this is the fallback). |
...
| 80 | `heading` | A semantic heading tag (`<h1>`–`<h6>`), or a text node the heuristics score as a heading. Level ≤ 2 becomes a page **Title** (larger Display type); level ≥ 3 a section heading. | [Special Heading](./special-heading.md) → [`special_heading`](/shortcodes/content-elements/special-heading) | Degrades to `text_block`, then `code_block`. |
...
| 66 | `posts` | A blog/post grid — repeating cards each with an image, title, and meta (a "latest articles" section). | [Posts](./posts.md) → [`posts`](/shortcodes/components/posts) | Degrades to `code_block`. |
| 65 | `avatar` | An overlapping avatar stack — a row of small round profile images with a "+N" counter (a "trusted by" / "join N customers" cluster). | [Avatar](./avatar.md) → [`avatar`](/shortcodes/components/avatar) | Degrades to `code_block`. |
| 64 | `gallery` | An image gallery / grid — three or more images in a repeating grid or collage (fewer than three falls back to code). | [Gallery](./gallery.md) → [`gallery`](/shortcodes/media-elements/gallery) | Degrades to `code_block` (fewer than 3 images). |
| 62 | `video` | A `<video>` or a video embed (YouTube / Vimeo) that isn’t a full-screen section background. | [Media Video](./media-video.md) → [`media_video`](/shortcodes/media-elements/media-video) | Degrades to `code_block`. |
| 60 | `image` | A content `<img>` (not a background image, an icon, or part of a decomposed composite). | [Media Image](./media-image.md) → [`media_image`](/shortcodes/media-elements/media-image) | Degrades to `code_block`. |
...
| 58 | `image_box` | An image paired with a title + text (a media card / feature block — image beside or above a heading and copy). | [Image Box](./image-box.md) → [`image_box`](/shortcodes/media-elements/image-box) | Degrades to `code_block`. |
| 55 | `floating_card` | A floating badge/card overlaid on a hero image (an icon + title + subtitle chip), or an icon + title + text card. | [Icon Box](./icon-box.md) → [`icon_box`](/shortcodes/components/icon-box) | Degrades to `code_block`. |
| 55 | `newsletter` | An email sign-up form — an email field + a subscribe button (often with a name field, on a call-to-action band). | [Newsletter](./newsletter.md) → [`newsletter`](/shortcodes/interactive-elements/newsletter) | Degrades to `code_block`. |
...
| 50 | `text` | A paragraph / body-copy block (typically `<p>` or a text container) that isn't a heading, button, or other recognized primitive. Short ALL-CAPS or eyebrow-classed text is refined to an **overline** instead. | [Text Block](./text-block.md) → [`text_block`](/shortcodes/content-elements/text-block) | Degrades to `code_block`. |
| 50 | `counter` | A big animated stat — a number (often with a prefix/suffix like $ or %) shown as a "count-up" figure with a small label. | [Counter](./counter.md) → [`counter`](/shortcodes/interactive-elements/counter) | Degrades to `code_block`. |
| 45 | `list` | A `<ul>` or `<ol>` list — bulleted, numbered, or an icon list. | [Feature List](./feature-list.md) → [`feature_list`](/shortcodes/components/feature-list) | Degrades to `code_block` (an empty list). |
...
| 40 | `button` | A `<button>`, or an `<a>` styled as a button (a `btn` / `button` / `cta` class, or button-like padding + fill). | [Button](./button.md) → [`button`](/shortcodes/components/button) | Degrades to `code_block`. |
| 40 | `image` | An `<img>` / `<picture>` / a CSS `background-image` on a content block. | `media_image` | Degrades to `code_block`. |
| 35 | `testimonials` | A review / quote block — a customer quote with a name, role, avatar, and often a star rating; one or several as a set. | [Testimonials](./testimonials.md) → [`testimonials`](/shortcodes/components/testimonials) | Degrades to `code_block`. |
...
| 30 | `badge` | A small pill / chip / label — a short rounded element with sub-tag text, a leading/trailing icon, and an optional link (an eyebrow, a status badge, a "what’s new" chip). | [Badge](./badge.md) → [`badge`](/shortcodes/content-elements/badge) | Degrades to `code_block`. |
...
| 25 | `accordion` | A toggle / disclosure group — a set of clickable headers each revealing a panel of content (an FAQ, a details list). | [Accordion](./accordion.md) → [`accordion`](/shortcodes/interactive-elements/accordion) | Degrades to `code_block`. |
...
| 20 | `table` | A `<table>` with at least one row and column. | [Table](./table.md) → [`table`](/shortcodes/content-elements/table) | Degrades to `code_block`. |
