...
description: How the UnysonPlus Site Converter derives the Color Presets preset library in Theme Settings → Components from a source design.
...
**1/1 derived from the source** (100%) — 🟡 0 via CSS · ⚪ 0 default/manual · ⚙️ 1 auto.
