...
[custom cursor](./cursor.md), [page transitions](./page-transitions.md),
[scroll progress](./scroll-progress.md) — load only when you've switched them on, and only the one
style you picked.
:::
