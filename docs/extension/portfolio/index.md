...
In the [config.php](/docs/creating-extensions/introduction) file, you can set the portfolio Gallery and Featured Image sizes.
...
Templates are located in the [views/](/docs/creating-extensions/introduction) directory. Here is the list of templates that you can customize:
