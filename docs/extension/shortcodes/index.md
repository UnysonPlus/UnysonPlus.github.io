...
- If you are developing a [unyson extension](/docs/creating-extensions/create-extension) and you want to offer some functionality from the extension via a shortcode you should create the it at `framework-customizations/extensions/{your-extension}/shortcodes/{your-shortcode}`. One such example from the built-in extensions is the slider extension and it's shortcode.
