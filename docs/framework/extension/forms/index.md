...
First, make sure you understand [how the base builder works](/docs/framework/extension/builder).
...
At this point the item is working only in backend. If you save the form, add it in a page (or post) using [Page Builder](/docs/framework/extension/shortcodes) and open that page in frontend, you will see the item attributes array.
