...
In the [config.php](/docs/framework/extensions/introduction) file, you can set the portfolio Gallery and Featured Image sizes.
...
Templates are located in the [views/](/docs/framework/extensions/introduction) directory. Here is the list of templates that you can customize:
