...
- `manifest.php` - The only required file, all other files are optional. It contains the base information about extension. More details about the [extension manifest](/docs/framework/manifest/extension).
