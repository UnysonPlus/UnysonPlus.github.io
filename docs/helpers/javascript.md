...
Modal with [options](/docs/options/introduction). Display html generated from a given options array. After the user completes the form and presses "Save", values are available as a javascript object.
