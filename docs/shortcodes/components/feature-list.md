...
An icon-led list — checklist, cross/mixed, numbered or per-item icons — with optional sub-text and links, laid out in one or more columns. Tabs: **Content**, **Design**, **Styling**, **Animations**, **Advanced**.
...
- **Items** — an addable, repeatable list of features. Each item opens an Add / Edit Item popup with these sub-fields:
  ...
  - **Icon** — an icon (icon-v2 picker) used by the "Per-item icons" / "Badge" designs.
