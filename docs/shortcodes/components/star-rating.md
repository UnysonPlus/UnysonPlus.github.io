...
**▶ [See the Star Rating live on the demos site](https://demos.unysonplus.com/shortcodes/star-rating/)** — an interactive example you can click through.
...
- **Show Value** — `Yes` (default) or `No` — show "4.5/5" after the symbols.
- **Count Text** — optional text, e.g. "based on 220 reviews".
...
- **Font Size** — font-size preset for the rating.
