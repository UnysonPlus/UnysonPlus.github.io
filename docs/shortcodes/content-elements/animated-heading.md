...
| Option | Choices |
| --- | --- |
| **Before Text** | Static text before the rotating words |
| **Rotating Words** | One word/phrase per line |
| **After Text** | Static text after the rotating words |
| **HTML Tag** | H1–H6 · Paragraph · Div |
