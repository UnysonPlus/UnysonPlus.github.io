...
Visitors expect the site logo in the header to link back to the home page — a long-standing convention worth keeping. If the logo is an image, its `alt` should be the site name (e.g. "UnysonPlus — home"), not the word "logo". [MDN: the img element](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img) · [Web Dev Basics: Accessibility](/learn/accessibility)
:::
