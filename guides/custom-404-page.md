...
With the [Theme Builder](/extensions/theme-builder) you design it visually and assign it to the
...
2. **Body Templates → Add New**. Build your 404 layout with the page builder, a heading ("Page not
   found"), a [Site Search](/shortcodes/header-footer-elements) element, a button back home, and
...
[Theme Builder → conditional assignment](/extensions/theme-builder/conditional-assignment).
:::

## See also

- [Theme Builder](/extensions/theme-builder)
