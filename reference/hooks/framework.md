...
| Hook | Type | Summary |
| --- | --- | --- |
| [`fw_before_init`](#h-fw-before-init) | action | — |
...
| [`fw:backend-option-view:design-default:responsive-classes`](#h-fw-backend-option-view-design-default-responsive-classes) | filter | — |
...
```
<small>Fired in: `framework/bootstrap.php:43`</small>
...
```
<small>Fired in: `framework/bootstrap.php:207`</small>
...
```
<small>Fired in: `framework/views/backend-option-design-default.php:135`</small>
...
```
<small>Fired in: `framework/views/backend-option-design-default.php:56`</small>
